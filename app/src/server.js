...
/**
 * Hyperchat P2P - Server component
 * @version 1.0.1
 *
 */
...
const api_key_secret = process.env.API_KEY_SECRET || "hyperchat_default_secret";
...
app.post([apiBasePath + "/meeting"], (req, res) => {
  ...
  if (authorization != api_key_secret) {
    log.debug("Hyperchat get meeting - Unauthorized", {
      header: req.headers,
      body: req.body,
    });
  ...
  log.debug("Hyperchat get meeting - Authorized", {
    header: req.headers,
    body: req.body,
    meeting: meetingURL,
  });
